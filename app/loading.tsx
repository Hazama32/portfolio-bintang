  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-gray-900 
      ...
      <div className="flex space-x-3 justify-center items-center">
        ...
        {/* Blok 2 */}
        <div className="h-12 w-3 bg-teal-400 rounded-sm animate-bounce duration-[15000ms] [animation-delay:-0.5s] shadow-lg ease-in-out"></div>
        
        {/* Blok 3 */}
        <div className="h-12 w-3 bg-cyan-400 rounded-sm animate-bounce duration-[15000ms] [animation-delay:-1.0s] shadow-lg ease-in-out"></div>
        
        {/* Blok 4 */}
        <div className="h-12 w-3 bg-lime-400 rounded-sm animate-bounce duration-[15000ms] [animation-delay:-1.5s] shadow-lg ease-in-out"></div>
      </div>
